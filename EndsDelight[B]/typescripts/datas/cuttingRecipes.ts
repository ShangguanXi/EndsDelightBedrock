...
type CuttingBoardResult = { item: string; count?: number; chance?: number };

interface CuttingBoardRecipe {
    result: CuttingBoardResult[];
...
export const EndsCuttingBoardRecipes: CuttingBoardRecipe[] = [
    // 龙腿 → 生龙肉 + 骨粉
