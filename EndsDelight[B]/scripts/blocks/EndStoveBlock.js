...
export class EndStoveBlock extends BlockWithEntity {
    placeBlock(args) {
        ...
        if (block.typeId != "ends_delight:end_stove")
            return;
        //放置直接为点燃状态
        block.setPermutation(block.permutation.withState('farmersdelight:is_working', true));
        const { x, y, z } = block.location;
        const entity = super.setBlock(args.block.dimension, { x: x + 0.5, y: y, z: z + 0.5 }, "ends_delight:end_stove");
        world.scoreboard.addObjective(entity.typeId + entity.id, entity.id).setScore('amount', 0);
    }
    useOnBlock(args) {
        if (args?.block?.typeId !== "ends_delight:end_stove")
            return;
...
], EndStoveBlock.prototype, "placeBlock", null);
__decorate([
    EventAPI.register(world.afterEvents.itemUseOn),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [ItemUseOnAfterEvent]),
    __metadata("design:returntype", void 0)
], EndStoveBlock.prototype, "useOnBlock", null);
//# sourceMappingURL=EndStoveBlock.js.map