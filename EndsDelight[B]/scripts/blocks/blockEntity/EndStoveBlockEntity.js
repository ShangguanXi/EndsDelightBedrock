...
import { BlockEntity } from "../../lib/blockEntity/BlockEntity";
...
export class EndStoveBlockEntity extends BlockEntity {
    tick(args) {
        ...
        super.blockEntityLoot(entityBlockData, "ends_delight:end_stove", itemStackArr(itemStackScoresData) ?? null);
    }
}
__decorate([
    EventAPI.register(world.afterEvents.dataDrivenEntityTrigger, { entityTypes: ["ends_delight:end_stove"], eventTypes: ["farmersdelight:stove_tick"] }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], EndStoveBlockEntity.prototype, "tick", null);
//# sourceMappingURL=EndStoveBlockEntity.js.map